...
Каждый чан проходит через унификацию текста, а имено:
...
Допонительные сведения позволяют выполнять более точный поиск и получить исходный текст для дальнейщего использования в качестве контекста LLM.
